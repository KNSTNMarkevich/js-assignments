...
## Javascript Assignments  [![Build Status](https://travis-ci.org/KNSTNMarkevich/js-assignments.svg?branch=master)](https://travis-ci.org/KNSTNMarkevich/js-assignments)
